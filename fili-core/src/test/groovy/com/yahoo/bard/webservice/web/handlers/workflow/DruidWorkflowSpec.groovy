...
class DruidWorkflowSpec extends Specification {
    ...
    private static final String UNCOVERED_KEY = SYSTEM_CONFIG.getPackageVariableName("druid_uncovered_interval_limit")
    ...
    def "Test workflow contains DruidPartialDataRequestHandler when druidUncoveredIntervalLimit > 0"() {
        setup:
        SYSTEM_CONFIG.setProperty(UNCOVERED_KEY, '10')
        dw = new DruidWorkflow(
                dataCache,
                uiWebService,
                nonUiWebService,
